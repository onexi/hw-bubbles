...
describe('Catalog', function() {
	it('Page Count', function() {
        //this.timeout(5000); //sindimo, I increased the timeout for mocha here so it 'npm test' won't fail
		var links = ex.one();
...
describe('Catalog Files', function() {
	it('File Count', function() {
        //this.timeout(60000); //sindimo, I increased the timeout for mocha here so it 'npm test' won't fail since curl is slow
		ex.two();
