...
exercise.one = function () {
    ...
    target = 'http://student.mit.edu/catalog/index.cgi'
    ...
    var urls = []
    var prefix = "http://student.mit.edu/catalog/";

    return get(target).then(function (res) {
        var cio = cheerio.load(res);
        cio('li > a').each(function (i, el) {
            urls.push(prefix + cio(el).attr('href'));
        });
        console.log(urls.length)
        return urls;
    }).catch(function (res) {
        console.log('cannot get target url >>' + res)
    });
